...
class VideoStreamHandler(SocketServer.StreamRequestHandler):
    ...
    # cascade classifiers
    stop_cascade = cv2.CascadeClassifier('haar_cascade/stop_sign.xml') #E:/8th Sem/Capstone/Self Driving Car/pc files/
...
class ThreadServer(object):
    ...
    video_thread = threading.Thread(target=server_thread1,args=('192.168.43.19', 8000))
    video_thread.start()
    distance_thread = threading.Thread(target=server_thread2,args=('192.168.43.19', 8002))
